...
package com.ipd.jumpbox.jumpboxlibrary.widget.wheelview;
...
import com.ipd.jumpbox.jumpboxlibrary.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private static final String CENTER_RECT_COLOR = "#00A2BA";
...
//        int offset = (int) (getItemHeight() / 2 * 1.2);
        ...
        paint.setColor(Color.parseColor(CENTER_RECT_COLOR));
        // 设置线宽
